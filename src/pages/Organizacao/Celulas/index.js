...
function Celulas() {
  ...
  <Menu/>
    ...
    <h5 className='mb-4'><b>Celulas</b></h5>
    <div>
            ...
            <table className="table" striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th>Lider</th>
                  <th>Endereço da celula</th>
                  <th>Horario da celula</th>
                  <th>Dias da semana</th>
                  <th>Numero de menbros</th>
  ...
  <Modal show={showAddMenbro} onHide={handleCloseAddMenbro}>
        <Modal.Header closeButton>
          <Modal.Title>Criar celula</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Container className='p-0'>
            <Row>
              ...
              <Col md={6} className="mb-4">
              <div className="card-form-modal border">
              <div className='label'><span>Horario </span></div>
              <input type="time" class="form-control" placeholder=""/>
              </div>
              </Col>
              <Col md={6} className="mb-4">
              <div className="card-form-modal border">
              <div className='label'><span>	Dias da semana</span></div>
              <input type="date" class="form-control" placeholder=""/>
              </div>
              </Col>
              <Col md={6} className="mb-4">
              <div className="card-form-modal border">
              <div className='label'><span>Numero de menbros</span></div>
              <input type="number" class="form-control" placeholder=""/>
              </div>
              </Col>
              <Col md={12}>
              <div className="card-form-modal border">
              <div className='label'><span>Marcação</span></div>
              <input type="number" class="form-control" placeholder=""/>
              </div>
              </Col>
            </Row>
